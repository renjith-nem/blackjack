...
test('Test Deal with Dealer card hidden', () => {
    ...
    expect(blackjack.getDealerCards()[1].getCardValue()).toEqual(HiddenCard.Hidden);
    expect(blackjack.getDealerCards()[1].getSuite()).toEqual(HiddenCard.Hidden);
    expect(blackjack.getDealerCards()[0].getCardValue()).not.toEqual(HiddenCard.Hidden);
    expect(blackjack.getDealerCards()[0].getSuite()).not.toEqual(HiddenCard.Hidden);
});
